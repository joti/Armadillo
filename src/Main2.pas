...
procedure TForm1.AbraMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm1.AbraMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
...
procedure TForm1.AbraMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
...
begin
  ...
  most1.x:=Left;
  most1.y:=Top;
  UjForm:=SettingsForm.Create (Application);
...
procedure TForm1.FrissitClick(Sender: TObject);
...
procedure TForm1.NagyitChange(Sender: TObject);
begin
  Zoomol:=False;
  Lupe:=True;
  Lupe2:=True;
...
procedure TForm1.BeallitClick(Sender: TObject);
begin
  UjForm.Visible:=True;
...
procedure TForm1.PapirmenuClick(Sender: TObject);
begin
  PageForm.Showmodal;
end;

procedure TForm1.EgysegChange(Sender: TObject);
var i: Byte;
begin
...
procedure TForm1.EszkoztareClick(Sender: TObject);
begin
...
procedure TForm1.NagyitKeyPress(Sender: TObject; var Key: Char);
begin
 if Key=#27 then
  begin
   Edit1.TabStop:=True;
...
procedure TForm1.MeretaranyKeyPress(Sender: TObject; var Key: Char);
begin
 if Key=#27 then
  begin
   Edit1.TabStop:=True;
...
procedure TForm1.TeljesClick(Sender: TObject);
begin
  Crop:=False;
...
procedure TForm1.EgyebClick(Sender: TObject);
begin
...
procedure TForm1.StatuszsoreClick(Sender: TObject);
begin
...
procedure TForm1.MeretezoeClick(Sender: TObject);
begin
...
procedure TForm1.EgysegEnter(Sender: TObject);
begin
  Egyseg.TabStop:=True;
...
procedure TForm1.MeretaranyEnter(Sender: TObject);
begin
  Egyseg.TabStop:=True;
  Meretarany.TabStop:=True;
  Nagyit.TabStop:=True;
...
procedure TForm1.NagyitEnter(Sender: TObject);
begin
  Egyseg.TabStop:=True;
  Meretarany.TabStop:=True;
  Nagyit.TabStop:=True;
...
procedure TForm1.EgysegKeyPress(Sender: TObject; var Key: Char);
begin
 if Key=#27 then
  begin
   Edit1.TabStop:=True;
