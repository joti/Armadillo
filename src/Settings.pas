...
procedure TSettingsForm.VetuletChange(Sender: TObject);
begin
  Vetvalt:=True;
  Lupe:=False;
  Lapba:=False;
...
procedure TSettingsForm.CsaladChange(Sender: TObject);
var h,i,k:byte;
begin
  Vetvalt:=True;
  Lupe:=False;
...
procedure TSettingsForm.KontiClick(Sender: TObject);
begin
...
procedure TSettingsForm.Orszagclick(Sender: TObject);
begin
...
begin
  ...
  if aktiv in [94,95,98] then ParametersForm3.Showmodal else
  if aktiv in [109,110] then ParametersForm4.Showmodal else
  ParametersForm1.ShowModal;
end;

procedure TSettingsForm.Label1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TSettingsForm.Label1MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TSettingsForm.Fok1KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSettingsForm.SorrendButtonClick(Sender: TObject);
begin
  LayersForm.Show;
end;
