...
procedure TForm5.FekvoBtnClick(Sender: TObject);
begin
...
procedure TForm5.AlloBtnClick(Sender: TObject);
begin
  Valt:=True;
...
procedure TForm5.PapirComboboxChange(Sender: TObject);
begin
  Valt:=True;
...
procedure TForm5.PapirszelesEditExit(Sender: TObject);
begin
...
procedure TForm5.PapirmagasEditExit(Sender: TObject);
begin
...
procedure TForm5.PapirszelesEditKeyPress(Sender: TObject; var Key: Char);
begin
if Szamvizsgal(PapirmagasEdit.Text) then
  Lapy[6,Eta]:=StrToFloat(Copy(PapirmagasEdit.Text,1,szamhossz));
...
procedure TForm5.PapirmagasEditKeyPress(Sender: TObject; var Key: Char);
begin
if Szamvizsgal(PapirszelesEdit.Text) then
  Lapx[6,Eta]:=StrToFloat(Copy(PapirszelesEdit.Text,1,szamhossz));
...
procedure TForm5.PapirOKbtnClick(Sender: TObject);
begin
  Close;
end;
...
procedure TForm5.PapirCancelbtnClick(Sender: TObject);
begin
